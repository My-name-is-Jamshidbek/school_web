    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-10"><h1 class="card-title">Olimpiadachi qo'shish<h1></div>
                </div>
                <hr>
                <div class="card-body">
                    ...
                    <form action="{{route('admin.olimpic.store')}}" method="POST" accept-charset="UTF-8"
                        ...
                        <div class="form-group">
                            <label for="description">Olimpiadachi haqida batafsil</label>
